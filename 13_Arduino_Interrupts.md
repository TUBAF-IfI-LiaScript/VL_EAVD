...
![Bildtext](./images/13_Interrupts/UltraschallPrinzip.png "Prinzipskizze Schallausbreitung")<!-- width="50%" -->
[^1]
...
![RoboterSystem](./images/13_Interrupts/Schallgeschwindigkeit.png)<!--style="width: 70%; max-width: 720px;"-->
